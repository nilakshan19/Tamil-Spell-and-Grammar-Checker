# -*- coding: utf-8 -*-
"""spell checker_Levenshtein.ipynb
...
# Define the function to correct text using Levenshtein distance
def correct_text_with_levenshtein(test_sentence, correct_words):
    """Corrects the given text using Levenshtein distance."""
    words = test_sentence.split()
    corrected_words = []
    corrected_items = []  # To store words that were corrected

    for word in words:
        # Find the closest correct word using Levenshtein distance
...
for idx, wrong_sentence in enumerate(wrong_sentences):
    ...
    # Correct the wrong sentence and get the corrected words using Levenshtein distance
    corrected_sentence, corrected_items = correct_text_with_levenshtein(wrong_sentence, correct_words)
